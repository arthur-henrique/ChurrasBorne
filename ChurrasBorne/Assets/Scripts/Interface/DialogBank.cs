...
public class DialogBank : MonoBehaviour
{
    ...
    public static string[][,] english_dialog_bank_new = new string[][,]
    {
        ...
        new string[,] { // 13 - Bruna, hub, quest
            ...
            { "left" , "Sabet", "Sabet_1", "...?"},
            { "right" , "Bruna", "Bruna_1", "Alrighty, I knew you'd understand. Basically, I wasn't dragged by that uggo monster, I was there studying a new type o' magic ice that never melts, ya know, to keep the elixir cold all day and night."},
            { "left" , "Sabet", "Sabet_1", "...?"},
            { "right" , "Bruna", "Bruna_1", "I know I said I hate the bloody cold, but the Elixir only works if it's cold! As I was saying, I went there to research until that eight legged dunny kidnapped me, and when you rescued me I kinda forgot my magic brew there..."},
            { "left" , "Sabet", "Sabet_1", "...?"},
            { "right" , "Bruna", "Bruna_1", "Put a sock in it! Anyways, if you go there and get it for me, I'll give ya a pint, maybe some magic will help you deal with these wankers better."},
            { "left" , "Sabet", "Sabet_1", "...?"},
        ...
        new string[,] { // 14 - Bruna, hub, quest incompleta
            ...
            { "left" , "Sabet", "Sabet_1", "..."},
            { "right" , "Bruna", "Bruna_1", "Whaddya mean you still haven't got my special brew? It's chockers with nutritional... stuff, c'mon, on your bike!"},
            { "", "", "", ""},
        },
        new string[,] { // 15 - Bruna, hub, quest completa
            ...
            { "left" , "Sabet", "Sabet_1", "..."},
            { "right" , "Bruna", "Bruna_1", "Well good! And as promised, here's a pint, come back whenever you need some more juice from mama."},
            { "", "", "", ""},
        },
        new string[,] { // 16 - Bruna, hub, interação entre quests
            { "right" , "Bruna", "Bruna_1", "G'day B Boy, how are ya?"},
            { "left" , "Sabet", "Sabet_1", "..."},
            { "right" , "Bruna", "Bruna_1", "'S NOT A CONCOCTION! I know what I'm doin'!"},
            { "", "", "", ""},
        },
    ...
    public static string[][,] portuguese_dialog_bank_new = new string[][,]
    {
        ...
        new string[,] { // 13 - Bruna, hub, quest
            ...
            { "left" , "Sabet", "Sabet_1", "...?"},
            { "right" , "Bruna", "Bruna_1", "Sabia que você entenderia. Basicamente, eu não fui arrastada praquela caverna pelo bicho feio, eu estava lá pra estudar uma nova variante de gelo pro meu elixir, um gelo mágico que tem naquela caverna que não derrete nunca."},
            { "left" , "Sabet", "Sabet_1", "...?"},
            { "right" , "Bruna", "Bruna_1", "Eu sei que eu disse que odeio frio, mas é essencial pra confecção do Elixir. Como eu estava dizendo, eu fui lá pra pesquisar até que fui capturada pela baranga de oito patas, e quando você me resgatou eu meio que esqueci de levar a bebida de lá..."},
            { "left" , "Sabet", "Sabet_1", "...?"},
            { "right" , "Bruna", "Bruna_1", "Cala a boca! Enfim, se você for lá buscar eu te dou um gole quando você quiser, talvez facilite você enfrentar esses bichos feios."},
            { "left" , "Sabet", "Sabet_1", "...?"},
        ...
        new string[,] { // 14 - Bruna, hub, quest incompleta
            ...
            { "left" , "Sabet", "Sabet_1", "..."},
            { "right" , "Bruna", "Bruna_1", "Como assim você ainda não pegou o Elixir? É uma receita delicada! Acelera aí meu filho!"},
            { "", "", "", ""},
        },
        new string[,] { // 15 - Bruna, hub, quest completa
            { "right" , "Bruna", "Bruna_1", "Oi Churrasquinho, como está indo?"},
            { "left" , "Sabet", "Sabet_1", "..."},
            { "right" , "Bruna", "Bruna_1", "Opa, o elixir tava aberto? Bebeu um gole?"},
            { "left" , "Sabet", "Sabet_1", "..."},
            { "right" , "Bruna", "Bruna_1", "É bom mesmo! Bem, como prometido, toma aqui um frasco."},
            { "", "", "", ""},
        },
        new string[,] { // 16 - Bruna, hub, interação entre quests
            { "right" , "Bruna", "Bruna_1", "Oi Churrasquinho, como que vai na luta?"},
            { "left" , "Sabet", "Sabet_1", "..."},
            { "right" , "Bruna", "Bruna_1", "Eu não sou maluca! Eu sei o que eu to fazendo!"},
            { "", "", "", ""},
        },
        new string[,] { // 17 - Bruna, hub, interação quando o encapuzado está no HUB
    ...
    public static string[][,] spanish_dialog_bank_new = new string[][,]
    {
        ...
        new string[,] { // 13 - Bruna, hub, quest
            ...
            { "left" , "Sabet", "Sabet_1", "...?"},
            { "right" , "Bruna", "Bruna_1", "Sabía que lo entenderías. Básicamente, no me arrastró a esa cueva el bicho feo, estaba allí para estudiar una nueva variante de hielo para mi elixir, un hielo mágico que tienen en esa cueva y que nunca se derrite."},
            { "left" , "Sabet", "Sabet_1", "...?"},
            { "right" , "Bruna", "Bruna_1", "Sé que dije que odio el frío, pero es esencial para hacer Elixir. Como te decía, fui allí a investigarlo hasta que me capturó el matón de ocho patas, y cuando me rescataste se me olvidó traer la bebida de allí..."},
            { "left" , "Sabet", "Sabet_1", "...?"},
            { "right" , "Bruna", "Bruna_1", "¡Cállate! De todas formas, si vas a por él te daré de beber cuando quieras, quizá te haga más fácil enfrentarte a esos bichos tan feos."},
            { "left" , "Sabet", "Sabet_1", "...?"},
        ...
        new string[,] { // 14 - Bruna, hub, quest incompleta
            ...
            { "left" , "Sabet", "Sabet_1", "..."},
            { "right" , "Bruna", "Bruna_1", "¿Cómo que aún no tienes el Elixir? ¡Es una receta delicada! ¡Acelera, hijo mío!"},
            { "", "", "", ""},
        },
        new string[,] { // 15 - Bruna, hub, quest completa
