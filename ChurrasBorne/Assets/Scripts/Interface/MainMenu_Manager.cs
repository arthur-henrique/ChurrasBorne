...
public class MainMenu_Manager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        mixer.SetFloat("MasterVolumeParam", Mathf.Log10(PlayerPrefs.GetFloat("MASTER_VOLUME", 1)) * 20);
        ...
        menu_vol_master_slider.GetComponent<Slider>().value = PlayerPrefs.GetFloat("MASTER_VOLUME", 1);
        menu_vol_bgm_slider.GetComponent<Slider>().value = PlayerPrefs.GetFloat("BGM_VOLUME", 1);
        menu_vol_sfx_slider.GetComponent<Slider>().value = PlayerPrefs.GetFloat("SFX_VOLUME", 1);
    }
